...
namespace API.Data.Migrations
{
    ...
    [Migration("20230730175302_ModelCreation")]
            ...
            modelBuilder.Entity("API.Entities.ObavestenjeOIzvrsenojUplatiOsiguranja", b =>
                {
                    ...
                    b.ToTable("ObavestenjeOIzvrsenojUplatiOsiguranja");
                });
            ...
            modelBuilder.Entity("API.Entities.StavkaRacunaOsiguranja", b =>
                {
                    ...
                    b.Property<int?>("RacunOsiguranjaId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RacunOsiguranjaId");

                    b.ToTable("StavkaRacunaOsiguranja");
                });
            ...
            modelBuilder.Entity("API.Entities.UplatnicaZaOsiguranje", b =>
                {
                    ...
                    b.ToTable("UplatnicaZaOsiguranje");
                });
            ...
            modelBuilder.Entity("API.Entities.StavkaRacunaOsiguranja", b =>
                {
                    ...
                    b.HasOne("API.Entities.RacunOsiguranja", null)
                        .WithMany("StavkeRacunaOsiguranja")
                        .HasForeignKey("RacunOsiguranjaId");
